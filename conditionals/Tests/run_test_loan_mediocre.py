"""
Description: Script to test loanApproval_mediocre.py and and the test file
using Pytest and Pylint. Results written to a text file.
"""

import subprocess

pytest_command = ["python", "-m", "pytest", "-v", "test_loan_mediocre.py"]
pylint_command = ["python", "-m", "pylint", "--rcfile=.pylintrc", "../ProductionCode/loanApproval_mediocre.py"]
...
file = "test_results_loan_mediocre.txt"

"""
Description: Script to test loanApproval_good.py and and the test file
using Pytest and Pylint. Results written to a text file.
"""

import subprocess

pytest_command = ["python", "-m", "pytest", "-v", "test_loan_good.py"]
pylint_command = ["python", "-m", "pylint", "--rcfile=.pylintrc", "../ProductionCode/loanApproval_good.py"]
...
file = "test_results_loan_good.txt"

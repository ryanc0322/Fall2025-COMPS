# loan approval system that unethically penalizes unstable income types
# assumes that stability is better than income
...
if income_type == 1 and income >= 1500:
    print("Loan Approved.")
else:
    print("Loan Denied. Stable salaried income or higher income can strengthen your application.")

...
henderson_johnson_hospital_percent = (
    henderson_johnson_hospital / TOTAL_PATIENTS
) * 100
...
for i in range(len(ages)):
    if (
        hospitals[i] == "Henderson-Johnson Hospital"
        and medical_conditions[i] == "Cancer"
    ):
